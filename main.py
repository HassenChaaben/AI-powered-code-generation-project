...
llm = ChatGroq(
    ...
    max_tokens=4000,                         # Increased token limit for complex code                           # Longer timeout for complex generations
    max_retries=3,                          # More retries for reliability                         # Enable streaming for long responses
)
